...
describe('TextField component', () => {
  ...
  it('label is visible and has focused class when value is present', () => {
    render(
      <TextField value="John" placeholder="Your Name" onChange={() => {}} />,
    );
    const label = screen.getByText('Your Name');
  ...
  it('applies error class to wrapper when error prop is true', () => {
    render(
      <TextField value="" placeholder="Your Name" error onChange={() => {}} />,
    );
  ...
  it('calls onChange when typing', () => {
    ...
    render(
      <TextField value="" placeholder="Your Name" onChange={handleChange} />,
    );
    const input = screen.getByPlaceholderText('Your Name');
