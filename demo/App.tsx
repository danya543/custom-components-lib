    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            <div className={styles.part}>
                <h3>TextFields</h3>
                <TextField value={value} placeholder="Enter text" onChange={(e) => setValue(e.target.value)} />
                <TextField value={value1} placeholder="Enter text1" onChange={(e) => setValue1(e.target.value)} error={true} />
            </div>
